...
print("TEST PARSE IF", test_parser.test_if_parsing())
print("TEST PARSE FI", test_parser.test_fi_parsing())
print()
...
print("TEST INTERPRET IF", test_interpreter.test_if_interpreting())
